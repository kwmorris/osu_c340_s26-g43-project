...
-- Collect all attributes for all Assignments
SELECT assignmentID, name, description, dueDate, points FROM Assignments;
...
INSERT INTO Assignments (name, description, dueDate, points)
VALUES (@name, @description, @dueDate, @points);

-- Update an Assignment record
UPDATE Assignments
SET assignmentID = @newAssignmentID, name = @name, description = @description, dueDate = @dueDate, points = @points
